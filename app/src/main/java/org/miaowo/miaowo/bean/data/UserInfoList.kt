...
data class UserInfoList(
	...
	val usernames: List<UserName>? = null,
	...
	val uploadedpicture: String? = null,
        ...
        @field:SerializedName("passwordExpiry")
	val passwordExpiry: Int? = null,
