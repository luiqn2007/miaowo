...
public class C {
    ...
    final public static String EXTRA_ITEM2 = "extra_item2";

    // Sp设置数据
    final public static String SpName = "hqmiao";
    // 系统参数
    ...
    final public static String UI_SLIDE_USERSUMMARY_COLOR = "ui_slide_summary_color";
    ...
    // ListFragment
    final public static int LF_TYPE_DAILY = 1;
    final public static int LF_TYPE_ANNOUNCEMENT = 2;
    final public static int LF_TYPE_QUESTION = 3;
    final public static int LF_TYPE_WATER = 4;
    final public static int LF_POSITION_UP = 1;
