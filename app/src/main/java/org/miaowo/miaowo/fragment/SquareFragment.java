...
public class SquareFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_daily:
                FragmentUtil.showFragment(getChildFragmentManager(), R.id.container, fg_daily);
                break;
            case R.id.tv_announcement:
                FragmentUtil.showFragment(getChildFragmentManager(), R.id.container, fg_announcement);
                break;
            case R.id.tv_ask:
                FragmentUtil.showFragment(getChildFragmentManager(), R.id.container, fg_ask);
                break;
            case R.id.tv_water:
                FragmentUtil.showFragment(getChildFragmentManager(), R.id.container, fg_water);
                break;
            default:
                break;
        }
