 ...
 * <p>
 * 来源于 https://github.com/aosp-mirror/platform_frameworks_base/blob/8b36c0bbd1503c61c111feac939193c47f812190/core/java/android/text/Html.java
 * 由于不在系统包中，做出了一下修改：
 * 涉及到 Context 的，不使用 ActivityThread 而是直接传入参数
 * 涉及到 TextUtils 和 ArrayUtils 的，不使用而直接使用等价实现
 * 涉及到双向文字的，统一改为左到右LTR，没啥用
 */
...
public class Html {
    ...
    /**
     * Option for {@link #toHtml(Spanned, int, Context)}: Wrap consecutive lines of text delimited by '\n'
     * inside &lt;p&gt; elements. {@link BulletSpan}s are ignored.
     */
    public static final int TO_HTML_PARAGRAPH_LINES_CONSECUTIVE = 0x00000000;

    /**
     * Option for {@link #toHtml(Spanned, int, Context)}: Wrap each line of text delimited by '\n' inside a
    ...
    public static Spanned fromHtml(String source, Context context) {
        return fromHtml(source, FROM_HTML_MODE_LEGACY, null, null, context);
    }
     ...
     */
    public static Spanned fromHtml(String source, int flags, Context context) {
        return fromHtml(source, flags, null, null, context);
    }
     ...
     */
    @Deprecated
    public static Spanned fromHtml(String source, ImageGetter imageGetter, TagHandler tagHandler, Context context) {
        return fromHtml(source, FROM_HTML_MODE_LEGACY, imageGetter, tagHandler, context);
    }
    ...
    public static Spanned fromHtml(String source, int flags, ImageGetter imageGetter,
        ...
        HtmlToSpannedConverter converter =
                new HtmlToSpannedConverter(source, imageGetter, tagHandler, parser, flags, context);
        return converter.convert();
    }

    /**
     * @deprecated use {@link #toHtml(Spanned, int, Context)} instead.
     */
    @Deprecated
    public static String toHtml(Spanned text, Context context) {
        return toHtml(text, TO_HTML_PARAGRAPH_LINES_CONSECUTIVE, context);
    }
     ...
     */
    public static String toHtml(Spanned text, int option, Context context) {
        StringBuilder out = new StringBuilder();
        withinHtml(out, text, option, context);
        return out.toString();
    }
    ...
    private static void withinBlockquote(StringBuilder out, Spanned text, int start, int end,
                                         int option, Context context) {
        if ((option & TO_HTML_PARAGRAPH_FLAG) == TO_HTML_PARAGRAPH_LINES_CONSECUTIVE) {
            withinBlockquoteConsecutive(out, text, start, end, context);
        } else {
            withinBlockquoteIndividual(out, text, start, end, context);
        }
    }
...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    public HtmlToSpannedConverter(String source, Html.ImageGetter imageGetter,
                                  Html.TagHandler tagHandler, Parser parser, int flags, Context context) {
        mSource = source;
    ...
    private void handleStartTag(String tag, Attributes attributes, Context context) {
        if (tag.equalsIgnoreCase("br")) {
            ...
            startImg(mSpannableStringBuilder, attributes, mImageGetter, context);
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
            throws SAXException {
        handleStartTag(localName, attributes, mContext);
    }
